...
class AuthorizedHttp(object):
    ...
    def request(self,
        ...
        _credential_refresh_attempt = kwargs.pop('_credential_refresh_attempt',
                                                 0)
        ...
        self.credentials.before_request(self._request, method, uri,
                                        request_headers)
        ...
        if all(
                getattr(body, stream_prop, None)
                for stream_prop in _STREAM_PROPERTIES):
