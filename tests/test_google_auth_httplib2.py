...
class TestAuthorizedHttp(object):
    ...
    def test_add_certificate(self):
        ...
        authed_http.add_certificate("key",
                                    "cert",
                                    "domain",
                                    password="password")
    ...
    def test_request_no_refresh(self):
        ...
        authed_http = google_auth_httplib2.AuthorizedHttp(mock_credentials,
                                                          http=mock_http)
        ...
        assert mock_http.requests == [('GET', self.TEST_URL, None, {
            'authorization': 'token'
    ...
    def test_request_stream_body(self):
        ...
        assert response == mock_response
        assert data == mock_response.data
        assert mock_http.requests == [('POST', self.TEST_URL, body, {
            'authorization': 'token'
        }, httplib2.DEFAULT_MAX_REDIRECTS, None),
                                      ('POST', self.TEST_URL, body, {
                                          'authorization': 'token1'
                                      }, httplib2.DEFAULT_MAX_REDIRECTS, None)]
    ...
    def test_request_positional_args(self):
        ...
        response, data = authed_http.request(self.TEST_URL, 'GET', None, None,
